...
worldCoords(3) = depth - depth*(min(depthBuffer(:))/depthBuffer(1, 1));
disp(worldCoords(3)+0.05);


vrep.simxSetObjectPosition(id, targetHandle, -1, [worldCoords(1), worldCoords(2), worldCoords(3)+0.07], vrep.simx_opmode_oneshot);
